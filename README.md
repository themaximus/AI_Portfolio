...
🔗 **Live Link:** [https://github.com/themaximus/AI_Portfolio](https://github.com/themaximus/AI_Portfolio)
...
*   **Local Infrastructure:** [LM Studio](https://lmstudio.ai/) running offline LLMs (Local Llama/Mistral) for private code processing.
